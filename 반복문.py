...
#   for 요소 in 시퀀스 : 시퀀스의 각 요소를 순회하는데 사용 (자바의 향상된 for문 , C#의 Foreach 문과 동일)
...
# for i in range(10, 0 -1, -2) : # 10 ~ 0 까지 출력
#     print(i)
...
# 사각형 찍기
# 정수값을 n을 입력 받아 n * n크기의 행렬을 출력하는 프로그램 작성
# 값은 1부터 시작
